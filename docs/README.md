...
The spray wand is installed about 12 inches behind the camera. Camera points straight down and is about 18 inches above lawn. The camera is a fixed focus model. Wand servo is in line with camera height and centered on machine. Servo attaches to wand in center of handle.
