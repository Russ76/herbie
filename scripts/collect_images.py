#!/usr/bin/env python3
# Warning! This program will fill your disk quickly with large images.
...
camRgb.setVideoSize(1920, 300)
# With size set thus, image is near top of entire frame
# camRgb.setFrameRate(10)
camRgb.setFps(10)
# Lower framerate and image height. If doesn't work well, raise Fps to 20 or 30 (default)
# videoEnc.setDefaultProfilePreset(camRgb.setFps(10), dai.VideoEncoderProperties.Profile.MJPEG)
